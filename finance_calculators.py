...
# Statrting statments
print("\n------------------------------------------------------------------------------------")
print("invest - Calculate the amount of interest you will earn on your investment")
print("bond   - Calculate the amount you will have to pay on a home loan")
print("------------------------------------------------------------------------------------\n")


# User input
choice_1 = input("Enter 'invest' or 'bond' from the menu above to proceed: ").lower()

# Validations of the user input
if choice_1 == "invest" or choice_1 == "bond":
    print()
else:
...
if choice_1 == "investment":
    ...
    print(f"Your initial investment should turn into {final_amount_r}.")
